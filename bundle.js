...
/***/ function(module, exports, __webpack_require__) {
	...
	store.subscribe(function () {
	  ...
	  (0, _jquery2.default)('#count').text(store.getState());
	});
	
	(0, _jquery2.default)(document).ready(function () {
	  (0, _jquery2.default)('#inc').on('click', function () {
	    store.dispatch({
	      type: 'INC',
	      payload: 1
	    });
	  ...
	  (0, _jquery2.default)('#dec').on('click', function () {
	    store.dispatch({
	      type: 'DEC',
	      payload: 1
	    });
	  ...
	  (0, _jquery2.default)('#firstInput').on('keyup', function () {
	    var userInput = (0, _jquery2.default)(this).val();
	    userStore.dispatch({
	      type: 'FIRST',
	      payload: userInput
	    });
	  ...
	  (0, _jquery2.default)('#lastInput').on('keyup', function () {
	    var userInput = (0, _jquery2.default)(this).val();
	    userStore.dispatch({
	      type: 'LAST',
	      payload: userInput
	...
	var userStore = (0, _redux.createStore)(userReducer, userInitialState, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
	
	userStore.subscribe(function () {
	  console.log('user store changed', userStore.getState());
	
	  var _userStore$getState = userStore.getState(),
	      first = _userStore$getState.first,
	      last = _userStore$getState.last;
	
	  (0, _jquery2.default)('#first').text(first);
	  (0, _jquery2.default)('#last').text(last);
	});
