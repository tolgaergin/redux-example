...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderList(state) {
	  ...
	  (0, _jquery2.default)('#todoList').html(liElements);
	}
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  (0, _jquery2.default)(document).on('click', '.removeTodo', function () {
	    store.dispatch({
	      type: 'REMOVE',
	      id: (0, _jquery2.default)(this).parent().data('id')
	    });
	  });
	
	  (0, _jquery2.default)(document).on('click', '#addTodo', function () {
	    store.dispatch({
	      type: 'ADD',
	      data: {
	        id: todoLength,
	        text: (0, _jquery2.default)('#newTodo').val(),
	        status: 'ACTIVE'
	      }
	    });
	  ...
	  (0, _jquery2.default)(document).on('click', '.toggleEdit', function () {
	    (0, _jquery2.default)(this).next('div').removeClass('hidden');
	  });
	
	  (0, _jquery2.default)(document).on('click', '.editTodo', function () {
	
	    store.dispatch({
	      type: 'EDIT',
	      data: {
	        id: (0, _jquery2.default)(this).parents('li').data('id'),
	        text: (0, _jquery2.default)(this).prev('input').val(),
	        status: 'ACTIVE'
	      }
	    });
	  });
	...
	// reducers
	var reducerTodo = function reducerTodo(state, action) {
	  ...
	  if (action.type === 'ADD') {
	    var _newState = [].concat(_toConsumableArray(state), [action.data]);
	
	    return _newState;
	  }
	
	  if (action.type === 'EDIT') {
	    var findIndex = state.findIndex(function (todo) {
	      return todo.id === action.data.id;
	    });
	
	    var _newState2 = [].concat(_toConsumableArray(state.slice(0, findIndex)), _toConsumableArray(state.slice(findIndex + 1)), [action.data]);
	...
	// store
	var store = (0, _redux.createStore)(reducerTodo, initialTodo, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
